...
namespace DreamPlanner_Main.Controllers.UserDefinedControllers
{
    public class HallsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "HallId,HallName,HallCapacity")] Hall hall)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "HallId,HallName,HallCapacity")] Hall hall)
        {
            if (ModelState.IsValid)
            {
